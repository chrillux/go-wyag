...
func TestObject_deserialize(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// },
			args: args{
				data: bytes.NewBuffer([]byte{98, 108, 111, 98, 32, 55, 0, 102, 111, 111, 98, 97, 114, 10}),
			},
			wantErr: false,
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			o := &Object{
				// serializedData:   tt.fields.serializedData,
				// deserializedData: tt.fields.deserializedData,
